						...
						<div class="detail-info">
                            ...
                            <div class="quantity">
								...
								<div class="quantity-input">
									<input type="text" wire:model="quantity.{{ $product->id }}" name="product-quatity" data-max="120" pattern="[0-9]*" >
									
									<a class="btn btn-reduce" href="" wire:click.prevent="reduce({{$product->id}})"></a>
									<a class="btn btn-increase" href="" wire:click.prevent="increase({{$product->id}})"></a>
								</div>
							</div>
